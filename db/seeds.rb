...
user = User.find_or_initialize_by(full_name: 'rati jebisashvili', email: 'rjebisashvili@gmail.com')
user.assign_attributes(password: 'raduga30', password_confirmation: 'raduga30')
user.save

country = Country.find_or_create_by(name: 'Georgia', code: 'GE', active: true)
city = City.find_or_create_by(name: 'Tbilisi', code: '01', active: true, country_id: country.id)
